	...
	>
			...
			<div class="d-inline-flex width-full">
				...
				>
					<ProgressBar
						...
						:width="70"
						font-size="20"
						:pv="progressPercent(ownItem.drugs,drugsCost,drugs_amount)"
						:total="ownItem.drugs"
						:cost="drugsCost"
						:bold="12"
				...
				>
					<ProgressBar
						...
						:width="70"
						font-size="20"
						:pv="progressPercent(ownItem.weapons,weaponsCost,weapons_amount)"
						:total="ownItem.weapons"
						:cost="weaponsCost"
						:bold="12"
						:text-bg-color="'#1f1f1f'"
						:during="3"
				...
				>
					<ProgressBar
						...
						:width="70"
						font-size="20"
						:pv="progressPercent(ownItem.alcohol,alcoholsCost,alcohol_amount)"
						:total="ownItem.alcohol"
						:cost="alcoholsCost"
						:bold="12"
						:text-bg-color="'#1f1f1f'"
						:during="3"
		...
		<div class="mx-auto">
			<CheckoutGangBuilding
				...
				:notEnoughForUpgrade="hasNotEnoughForUpgrade"
				:drugs="drugs_amount"
