   ...
   const mapPoint = (lat, lng, scale) => {
    ...
    const  renderToCanvas = (width, height, renderFunction) => {
  ...
  const createLabel = (text, size, color, font, underlineColor) => {
  ...
  export { mapPoint, renderToCanvas, createLabel, hexToRgb };