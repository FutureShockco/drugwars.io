<template>
    <div class="d-flex flex-lg-row flex-column text-center text-lg-left item" :class="{ progress: inProgress }">
        <div class="item-content width-full mr-3 mb-4">
            ...
            <Cost :drugsCost="unit.drugs_cost" :weaponsCost="unit.weapons_cost" :alcoholsCost="unit.alcohols_cost" :quantity="quantity" />Supply : {{unit.supply}}
        ...
        <div class="mx-auto">
            ...
            <CheckoutRecruit :id="unit.id" :level="training_facility.lvl" :coeff="unit.coeff" :inProgress="inProgress" :price="unit.drugs_cost / 120000  + unit.weapons_cost / 120000 + unit.alcohols_cost / 120000 " :notEnough="hasNotEnough" :quantity="quantity" />
        </div>
    </div>
</template>
