    ...
    computed: {
        classes() {
            return [
                ...
                this.maximized ? 'vb-maximized' : '', !this.maximized && this.zooming ? 'vb-zoomed-out' : '',
            ];
        },
...
.vb-wrapper:not(.vb-multiple) {
    ...
    .vb {
        @media screen and (max-width: $small-screen-width), screen and (max-height: $small-screen-height) {
            .vb-content {
                height: 0px;
                max-height: 0px;
            }
