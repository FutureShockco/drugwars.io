  ...
  <div id="app">
    ...
    <!-- <cookie-law style="z-index:99999">
      <div slot="message">
        ...
        >IMPORTANT NOTE: DRUGWARS v0.6 IS GOING TO BE RELEASED, THE GAME WILL NOT BE AVAILABLE FROM 2PM TO 8PM UTC TIME THE 06/01/2020. THANK YOU FOR YOUR UNDERSTANDING</h3>
      </div>
    </cookie-law> -->
  </div>
</template>
